...
if (isset($_GET['reply'])) {
    ...
    $no = $_GET['reply'];
    $edit_select = "SELECT * FROM students WHERE no = $no ";
...
<div class="wrapper fadeInDown">
    <div id="formContent">
        <!-- Tabs Titles -->
        <h2 class="active">student messages List </h2>
        ...
        <div class="container col-11 mt-3 justify-content-center  text-ceter">
            <table class="table text-ceter">
                ...
                <th class="text-center">stu_id</th>
                ...
                <tr>
                    <?php foreach ($s as $data) { ?>
                        ...
                        <td class="text-center" ><?php echo $data['stud_id'] ?></td>
                        ...
                        <td class="text-center" colspan="2">
                            ...
                            <td class="text-center"> <a href="send.php?reply=<?php echo $data['no'] ?>" class="btn btn-outline-success text-dark">REPLY</a></td>
                            <td class="text-center"> <a href="list.php?delete=<?php echo $data['no'] ?>" class="btn btn-outline-danger text-dark">delete</a></td>
