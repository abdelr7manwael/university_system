...
if (isset($_POST['upload'])) {
    ...
    $update = "UPDATE doctors SET doc_image= '$img_name' where id= $id ";
        ...
        <div class=" col-lg-2">
            ...
            <div class="child-pic  ">
                <form action="profile.php" method="POST" enctype="multipart/form-data">
                    ...
                    <?php if ($row['doc_image']) : ?>
                        <img class="w-75 rounded-circle" style="cursor: pointer; max-height:190px;" src="../../project/assets/img/uploaded/<?php echo $row['doc_image'] ?>" alt="mfe4 sora">
                    <?php else : ?>
                ...
                <h3 class="mt-2 text-dark fw-bold  "><?php echo $_SESSION['doctor']; ?></h3>
                <a href="/project/doctor/index.php"> <button class="butn">Dashboard</button> </a>
                <a href="/project/doctor/courses/list.php"><button class="butn">Coursers</button></a>
                <a href="/project/doctor/doc_msg/send.php"><button class="butn">Send Message</button></a>
            ...
            <div class="child-info">
                ...
                <table class="w-100 ">
                    <tr>
                        ...
                        <th>
                            <h4 class="text-start"><span style=" color:#5fcf80; font-size:20px; font-weight:bold"><?php echo $_SESSION['doctor']; ?></span></h4>
                        </th>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                            <h3 class=" text-center text-dark">doctor ID:</h3>
                        </th>
                        <th>
