...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="/project/doctor">Uni-Sys</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="active" href="/project/doctor">Dashboard</a></li>


          <li><a href="/project/doctor/courses/list.php">courses</a></li>

          <li class="dropdown"><a href="#"><span>message</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="/project/doctor/doc_msg/send.php">send</a></li>
              <li><a href="/project/doctor/doc_msg/list.php">list</a></li>

            </ul>
          </li>

          <li><a href="/project/doctor/profile.php">profile</a></li>
